...
class ExpirationCheckerBreadActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityExpirationCheckerBreadBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityExpirationCheckerBreadBinding.inflate(layoutInflater)
